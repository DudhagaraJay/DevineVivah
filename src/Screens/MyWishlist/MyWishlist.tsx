        ...
        <Pressable onPress={() => navigate("ProductView", { item })} style={styles.itemContainer}>
            ...
            <View style={styles.productInfo}>
                ...
                <View style={styles.priceRow}>
                    <Text style={[Typography.small, styles.lessPrice]}>RS.{item.lessprice}</Text>
                    <Text style={[Typography.small, styles.price]}>RS.{item.price}</Text>
            ...
            <View style={styles.footer}>
                ...
                <Text style={[Typography.small, styles.rating]}>{item.reting}</Text>
                <Text style={[Typography.small, styles.review]}>{item.review}</Text>
                <Text style={[Typography.small, styles.solds]}>{item.solds}</Text>
            </View>
        </Pressable>
    );
