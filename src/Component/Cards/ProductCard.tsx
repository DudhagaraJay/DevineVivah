        ...
        <Pressable onPress={() => navigate("ProductView", {item})} style={styles.itemContainer}>
            ...
            <View style={{ marginTop: 10, marginLeft: 10 }}>
                ...
                <View style={{ flexDirection: "row", alignItems: "center", gap: 5 }}>
                    <Text style={[Typography.small, { fontSize: FontSize.Font15, }]}>RS.{item.lessprice}</Text>
                    <Text style={[Typography.small, { fontSize: FontSize.Font15 }]}> {item.price}</Text>
            ...
            <View style={styles.footer}>
                ...
                <Text style={[Typography.small, { fontSize: FontSize.Font15 }]}>{item.reting}</Text>
                <Text style={[Typography.small, { fontSize: FontSize.Font15, marginRight: 5 }]}>({item.review})</Text>
                <Text style={[Typography.small, { fontSize: FontSize.Font15 }]}>{item.solds}</Text>
            </View>
        </Pressable>
